            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="datetime-local" class="form-control" id="dateTime" name="dateTime" value=<%=LocalDateTime.now().truncatedTo(ChronoUnit.SECONDS)%>/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="number" class="form-control" id="calories" name="calories" value=<%=AuthorizedUser.getCaloriesPerDay()%>>
                        </div>
                    </div>
