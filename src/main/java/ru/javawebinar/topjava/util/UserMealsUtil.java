...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        for (UserMealWithExceed userMealWithExceed : filteredWithExceeded) {
            System.out.println(userMealWithExceed.getDateTime() + " " + userMealWithExceed.isExceed());
        }
    }
    ...
    public static List<UserMealWithExceed> getFilteredWithExceeded(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal userMeal : mealList) {
            if (TimeUtil.isBetween(userMeal.getLocalTime(), startTime, endTime) && sumCaloriesInDay.get(userMeal.getLocalDate()) > caloriesPerDay) {
                mealsWithExceed.add(new UserMealWithExceed(userMeal, true));
            }
        }
